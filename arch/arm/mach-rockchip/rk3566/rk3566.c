...
#include <asm/arch-rockchip/grf_rk3566.h>
#include <asm/arch-rockchip/hardware.h>
#include <dt-bindings/clock/rk3566-cru.h>
...
static struct mm_region rk3566_mem_map[] = {
	{
		.virt = 0x0UL,
		.phys = 0x0UL,
		.size = 0xf0000000UL,
...
struct mm_region *mem_map = rk3566_mem_map;

void board_debug_uart_init(void)
{
	static struct rk3566_pmugrf * const pmugrf = (void *)PMUGRF_BASE;
	static struct rk3566_grf * const grf = (void *)GRF_BASE;
